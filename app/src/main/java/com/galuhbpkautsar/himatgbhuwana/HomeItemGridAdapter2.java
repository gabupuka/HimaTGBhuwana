 ...
 */
public class HomeItemGridAdapter2 extends BaseAdapter {
    private Context mContext;
    private Integer[] mThumbIds = {R.drawable.mi_logo, R.drawable.mi_logo, R.drawable.mi_logo};

    public HomeItemGridAdapter2(Context c) {
        mContext = c;
    }
